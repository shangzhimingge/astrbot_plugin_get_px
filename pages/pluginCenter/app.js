...
function renderPolicyManager() {
  ...
  [els.policyAddInput, els.policyAddCancel].forEach((control) => { if (control) control.disabled = state.policySaving; });
